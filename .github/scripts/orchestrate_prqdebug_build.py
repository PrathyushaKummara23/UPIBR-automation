...
SOC_TRIGGER = "soc_sign_trigger_gnr_debug_prq.txt"
SOC_DONE = "soc_sign_done_gnr_debug_prq.txt"
FIT1_TRIGGER = "fit1_sign_trigger_gnr_debug_prq.txt"
FIT1_DONE = "fit1_sign_done_gnr_debug_prq.txt"
...
def main():
    ...
    log("[INFO] Starting GNR PRQ debug build")
        ...
        while True:
            ...
            if (
                ...
                send_workflow_dispatch(
                    ...
                    inputs={"session_id": args.session_id},
                )
                soc_dispatched = True
