...
SOC_TRIGGER = "gnr_prod_soc_sign_trigger.txt"
SOC_DONE = "gnr_prod_soc_sign_done.txt"
FIT1_TRIGGER = "gnr_prod_fit1_sign_trigger.txt"
FIT1_DONE = "gnr_prod_fit1_sign_done.txt"
...
def send_workflow_dispatch(repo, workflow_file, github_token, inputs):
    ...
    response_file = "/tmp/github_dispatch_response_gnr_prod.txt"
